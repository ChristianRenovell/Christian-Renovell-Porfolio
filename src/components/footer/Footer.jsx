          ...
          <div className="col-sm-12 col-md-4">
            ...
            <div className="row mt=2 mb-5">
              <div className="col-3 col-md-3">
                <a target="_blank" href="https://t.me/Christianrenovell" className={`cursor-${props.mode}`}><img src={`${props.url}/assets/telegram-${props.mode}-footer.png`} width="35px"></img></a>
              </div>
              <div className="col-3 col-md-3">
              ...
              <div className="col-3 col-md-3">
                <a target="_blank" href="https://twitter.com/ChristianRenov2" className={`cursor-${props.mode}`}><img src={`${props.url}/assets/twitter-${props.mode}-footer.png`} width="35px"></img></a>
              </div>
              <div className="col-3 col-md-3">
