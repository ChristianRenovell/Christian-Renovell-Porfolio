                                ...
                                <div className="row skills-content">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="progress">
                                            ...
                                            <div className="progress-bar-wrap">
                                                <div className="progress-bar php" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div className="progress">
                                            <span className="skill">React.js <i class="val">75%</i></span>
                                            <div class="progress-bar-wrap">
                                                <div className="progress-bar react" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div className="progress">
                                            <span className="skill">Node.js <i class="val">65%</i></span>
                                            <div className="progress-bar-wrap">
                                                <div className="progress-bar node" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
