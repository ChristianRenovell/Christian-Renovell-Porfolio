                        ...
                        <div className="container">
                            <div className="row mt-5 pb-5">
                                <div className="col-6 col-md-3 mt-4">
                                    <a href="" className="iconProfile1"><img width="50px" src={`${process.env.REACT_APP_URL}/facebook-${props.mode}.png`} id="facebook" /></a>
                                </div>
                                <div className="col-6 col-md-3 mt-4">
                                    <a href="" className="iconProfile2"><img width="50px" src={`${process.env.REACT_APP_URL}/instagram-${props.mode}.png`} id="instagram" /></a>
                                </div>
                                <div className="col-6 col-md-3 mt-4">
                                    <a href="" className="iconProfile3"><img width="50px" src={`${process.env.REACT_APP_URL}/linkedin-${props.mode}.png`} id="linkedin" /></a>
                                </div>
                                <div className="col-6 col-md-3 mt-4">
                                    <a href="" className="iconProfile4"><img width="50px" src={`${process.env.REACT_APP_URL}/git-${props.mode}.png`} id="git" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
